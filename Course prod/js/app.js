...
let CursorCoordX;
let CursorCoordY;
let Interval = setInterval(NextBlur,5000)
...
BLURBTN.addEventListener('click',BlurUP)
...
function BlurUP(){
    ...
    BLUR.style.top = `${-BLUR.clientHeight}px`
    BODY.style.overflow = 'auto'
    CONTENT.style.animation = `content ${4}s forwards`
